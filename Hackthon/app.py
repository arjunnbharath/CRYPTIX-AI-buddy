...
# === OpenAI API Key ===
openai.api_key = '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'
    ...
    try:
        ...
        for article in top_headlines['articles'][:10]:
            news_list.append({
                ...
                'image': article.get('urlToImage') or 'https://via.placeholder.com/600x300/1f2937/ffffff?text=News'  # ✅ add fallback
            })
        return news_list
    except Exception as e:
